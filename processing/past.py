...
from timepred.models import TravelTime
...
def calculate_travel_times(n: int, before: datetime):
    ...
    with connection.cursor() as cursor:
        cursor.execute(
            ...
            FROM timepred_vehiclestoptime vst1
            JOIN timepred_vehiclestoptime vst2 ON vst1.trip_instance_id = vst2.trip_instance_id
